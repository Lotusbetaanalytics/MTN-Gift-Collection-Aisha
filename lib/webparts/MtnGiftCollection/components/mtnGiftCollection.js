...
var mtnGiftCollection = /** @class */ (function (_super) {
    ...
    mtnGiftCollection.prototype.render = function () {
        ...
        this.props.context.spHttpClient
            .get("https://mtncloud.sharepoint.com/sites/MTNNigeriaComplianceUniverse/testenv/_api/lists/GetByTitle('CURRENT HCM STAFF LIST')/items?$skiptoken=Paged=TRUE", SPHttpClient.configurations.v1)
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(HashRouter, null,
                React.createElement(Switch, null,
                    ...
                    React.createElement(Route, { path: "/admin/document/upload", exact: true, render: function (props) { return (React.createElement(UploadDocument, { context: _this.props.pageContext })); } }),
                    ...
                    React.createElement(Route, { path: "/admin/config", exact: true, render: function (props) { return (React.createElement(Config, { context: _this.props.pageContext })); } }),
