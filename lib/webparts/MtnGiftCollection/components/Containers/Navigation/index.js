...
var Navigation = function (_a) {
    var _b = _a.document, document = _b === void 0 ? "" : _b, _c = _a.config, config = _c === void 0 ? "" : _c, _d = _a.report, report = _d === void 0 ? "" : _d, _e = _a.pickups, pickups = _e === void 0 ? "" : _e, _f = _a.home, home = _f === void 0 ? "" : _f;
    return (React.createElement("div", { className: styles.mtn__navigation },
        React.createElement("div", { className: styles.mtn__url },
            React.createElement("ul", null,
                ...
                React.createElement("li", { className: styles[home] },
                    React.createElement(Link, { to: "/home" }, "Logout"))))));
};
