...
var Document = function () {
    ...
    var _l = React.useState(""), pickupLocation = _l[0], setPickupLocation = _l[1];
            ...
            React.createElement("div", { className: "contentsRight" },
                ...
                React.createElement("div", { style: {
                    ...
                    React.createElement("div", { style: {
                        ...
                        React.createElement("button", { onClick: editHandler, disabled: approvalStatus === "Pending" || approvalStatus === "Declined" ? false : true, className: "mtn__btn mtn__black" }, " Edit")),
                    ...
                    React.createElement("div", { style: { marginTop: "1rem", marginBottom: "1rem" } },
                        React.createElement(Select, { onChange: function (e) {
                            ...
                            }, title: Location, value: Location, options: locationOption, size: "mtn__adult", readOnly: approvalStatus === null ? false : true })),
                    ...
                    React.createElement("div", { style: {
                        ...
                        React.createElement("button", { disabled: approvalStatus === "Approved" || approvalStatus === "Pending" || approvalStatus === "Declined" || pickupLocation === "Off" ? true : false, className: "mtn__btn mtn__yellow", onClick: updateHandler }, " Submit"))))));
};
