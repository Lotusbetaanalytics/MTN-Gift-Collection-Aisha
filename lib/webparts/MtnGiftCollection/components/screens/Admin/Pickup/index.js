        ...
        React.createElement("div", { className: "contentsRight" },
            ...
            React.createElement("div", { className: "center", style: { marginTop: "50px" } }, loading ? (React.createElement(Spinner, null)) : (React.createElement(MaterialTable, { title: "", columns: columns, data: data, options: {
                ...
                actions: [
                    ...
                    Action: function (props) { return (React.createElement("button", { onClick: function (event) { return props.action.onClick(event, props.data); }, className: query === "Declined" || query === "Approved"
                            ? "no_display"
                            : "mtn__btn_table mtn__black" }, props.action.tooltip)); },
                } }))),
