...
var Location = function () {
    ...
    React.useEffect(function () {
        sp.web.lists.getByTitle("Location").items.get().then(function (res) {
            setData(res);
        });
    }, []);
    // Menubar Items
    ...
    var deleteHandler = function (id) {
        if (window.confirm("Are you sure you want to delete")) {
            sp.web.lists.getByTitle("Location").items.getById(id).delete().then(function (res) {
        ...
        React.createElement("div", { className: 'contentsRight' },
            ...
            React.createElement("div", { className: "spaceBetween" },
                ...
                React.createElement("div", { className: 'btnContainer right' },
                    React.createElement("button", { onClick: openHandler, className: "mtn__btns mtn__blue", type: 'button' }, "Add Location"))),
