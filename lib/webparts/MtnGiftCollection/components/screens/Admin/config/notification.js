...
var Division = function () {
    ...
    React.useEffect(function () {
        sp.web.lists.getByTitle("Notification").items.get().then(function (res) {
    ...
    return React.createElement("div", { className: "appContainer" },
        ...
        React.createElement("div", { className: 'contentsRight' },
            ...
            React.createElement("div", { className: "center", style: { marginTop: "50px", display: "flex", flexDirection: "column" } },
